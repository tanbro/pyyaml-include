...
PYTHON_LIST=(python3.6 python3.7 python3.8 python3.9 python3.10 python3.11 python3.12)
...
do
    ...
    $TMPDIR/bin/python -m pip install -U -e ./ -r tests/requirements.txt coverage
